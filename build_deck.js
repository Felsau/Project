...
const SHOT = (f) => path.join("C:", "Users", "ComSync", "Desktop", "Project", "screenshots", f);
...
const HF = "Tahoma";   // header font (renders Thai)
...
const LIVE = (f) => path.join("C:", "Users", "ComSync", "Desktop", "Project", "screenshots_live", f);
...
pres.writeFile({ fileName: "C:/Users/ComSync/Desktop/Project/GreenArea_Presentation_live.pptx" }).then((fn) => {
