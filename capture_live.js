...
const OUT = "C:/Users/ComSync/Desktop/Project/screenshots_live";
fs.mkdirSync(OUT, { recursive: true });
const sleep = (ms) => new Promise((r) => setTimeout(r, ms));

const KILL_ANIM = `(()=>{const s=document.createElement('style');s.id='noanim';s.innerHTML='*{animation:none!important;transition:none!important;scroll-behavior:auto!important}';document.head.appendChild(s);})()`;
